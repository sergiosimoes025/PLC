...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="autores" select="//autor[not(.=following::autor)]"></xsl:variable>
            ...
            <html>
                ...
                <body>
                  ...
                  <xsl:for-each select="$autores">
                      <xsl:sort select="."></xsl:sort>
                      <xsl:variable name="antes" select="."></xsl:variable>
                      <xsl:if test=".=$nome_autor">
                          <a href="{$antes}.html"><xsl:value-of select="$antes"></xsl:value-of></a>
                      </xsl:if>
