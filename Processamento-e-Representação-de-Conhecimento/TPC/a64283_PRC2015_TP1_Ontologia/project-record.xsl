...
<xsl:stylesheet 
    ...
    <xsl:template match="/">
        <html>
            ...
            <body>
                <center>
                    <h1 style="color:red;font-size:60px;">Project record</h1>
                </center>
                <hr/>
                <table width="100%">
                    <tr>
                        <td width="50%">
                            ...
                            <b>SUBTITLE: Processamento e Representação de Conhecimento </b> 
    ...
    <xsl:template match="deliverables">
        ...
        <i>Copyright Sérgio Simões - Fevereiro 2015</i>
    </xsl:template>
